...
import { AgencyContainer, AgencyHeader, AgencySidebar, OrderHistoryPanel, ResolutionPanel } from '../../components';
import {
    Calendar,
    DollarSign,
    User,
...
const OrderDetails = () => {
    ...
    useEffect(() => {
        const fetchOrderReviews = async () => {
            ...
            if (user?.userType !== 'agency') return; // student = buyer
                        ...
                        <div className="flex flex-col lg:flex-row gap-6">
                            ...
                            <div className="lg:w-1/3 space-y-4">
                                {!showResolution && !showOrderHistory ? (
                                    ...
                                    <OrderHistoryPanel
                                        userId1={user._id}
                                        userId2={(user.userType === 'buyer' || user.userType === 'agency') ? order.mentorId._id : order.studentId._id}
