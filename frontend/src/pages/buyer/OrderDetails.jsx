                                    ...
                                    {order.requirements?.status === 'submitted' || order.requirements?.text || order.requirements?.attachments?.length > 0 ? (
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-600 mb-4">
                                                Please provide detailed requirements for the freelancer to get started.
                                            </p>
                                    ...
                                    {(() => {
                                        ...
                                        return allDeliveries.length > 0 ? (
                                            ...
                                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                                                ...
                                                <p className="text-gray-600">
                                                    The freelancer hasn't delivered anything yet.
                                                </p>
                                            </div>
                                        );
                                    })()}
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            Chat with the freelancer about this order
                                        </p>
                                        <Link
                                    ...
                                    {order.status === 'active' && (
                                        <>
                                            ...
                                            >
                                                ...
                                                Message {order.seller?.firstName || 'Seller'}
                                            </Link>
                                            <button
            ...
            {showRevisionModal && selectedDelivery && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl max-w-lg w-full p-6">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                            Please provide detailed instructions for the freelancer on what changes you'd like to see.
                        </p>
