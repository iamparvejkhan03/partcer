                ...
                <Container className="py-3">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        {user && <nav className="hidden lg:flex items-center gap-8">
                            ...
                            {user && user?.userType == 'buyer' && <NavLink to="/freelancers" className="text-white/90 hover:text-white">
                                Search {userTypes?.freelancer}
                            </NavLink>}
                            ...
                            {user && user?.userType == 'buyer' && <NavLink to="/buyer/projects/all" className="text-white/90 hover:text-white">
                                My Projects
                            </NavLink>}

                            {user && user?.userType == 'buyer' && <NavLink to="/buyer/orders" className="text-white/90 hover:text-white">
                                My Orders
                            </NavLink>}
                        </nav>}
                        ...
                        {user && <div className="hidden lg:flex items-center gap-4">
                            {user && user?.userType == 'buyer' && <Link to="/buyer/projects/create" className="flex items-center gap-2 text-white cursor-pointer transition">
                                <Plus size={20} className="text-white cursor-pointer" />
                                <span>Post Project</span>
                            </Link>}

                            <button
                                className="flex items-center gap-2 text-white rounded-md cursor-pointer"
                            >
                                <img src={user?.profileImage || dummyUserImg} alt={user?.firstName} className='h-10 w-10 object-cover rounded-full' />
                            </button>
                        </div>}
                        ...
                        <div className="flex lg:hidden items-center gap-4">
                            {user ? (
                                <button
                                    ...
                                    onClick={() => navigate(`/${user.userType}/profile/settings`)}
                                >
